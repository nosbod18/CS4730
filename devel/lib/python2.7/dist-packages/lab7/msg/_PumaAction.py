...
"""autogenerated by genpy from lab7/PumaAction.msg. Do not edit."""
import codecs
import sys
...
class PumaAction(genpy.Message):
  _md5sum = "9d86356fd79bd6757527a39341fb1791"
  _type = "lab7/PumaAction"
...
"""
  ...
  _slot_types = ['lab7/PumaActionGoal','lab7/PumaActionResult','lab7/PumaActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PumaAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = lab7.msg.PumaActionGoal()
      if self.action_result is None:
        self.action_result = lab7.msg.PumaActionResult()
      if self.action_feedback is None:
        self.action_feedback = lab7.msg.PumaActionFeedback()
    else:
      self.action_goal = lab7.msg.PumaActionGoal()
      self.action_result = lab7.msg.PumaActionResult()
      self.action_feedback = lab7.msg.PumaActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_4I().pack(_x.action_goal.goal.puma_id, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.puma_id, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_4I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
