...
"""autogenerated by genpy from lab7/PumaActionResult.msg. Do not edit."""
import codecs
import sys
...
class PumaActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "lab7/PumaActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','lab7/PumaResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PumaActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = lab7.msg.PumaResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = lab7.msg.PumaResult()
