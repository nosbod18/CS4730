...
let PumaFeedback = require('./PumaFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class PumaActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new PumaFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PumaFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PumaActionFeedback(null);
    ...
    data.feedback = PumaFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PumaActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = PumaFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new PumaFeedback()
    }
...
module.exports = PumaActionFeedback;
